...
<head>
    ...
    <title>@yield('title', 'Dashboard') | Chapu CV</title>
    ...
    <div class="d-flex flex-column flex-root">
        <div class="page d-flex flex-row flex-column-fluid">
            <div id="kt_aside" class="aside aside-default aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto px-9 pt-9 pb-5" id="kt_aside_logo"><a
                        href="{{ route('dashboard') }}"><img alt="Chapu CV"
                            ...
                            class="max-h-50px logo-minimize"></a></div>
                    ...
                    <div class="menu menu-column menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-active-bg menu-state-primary fw-semibold fs-6 my-5 mt-lg-2"
                        ...
                        <div class="hover-scroll-y mx-4" data-kt-scroll="true" data-kt-scroll-height="auto">
                            ...
                            <div class="menu-item pt-5">
                                <div class="menu-content"><span class="fw-bold text-muted text-uppercase fs-7">Manage
                                        CV</span></div>
                            </div>
                            <div class="menu-item"><a class="menu-link" href="#cv-editor"><span class="menu-icon"><i
                            ...
                            <div class="menu-item"><a class="menu-link" href="#visitors"><span class="menu-icon"><i
                                            class="ki-duotone ki-profile-user fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span class="menu-title">Profile
                                        visitors</span></a></div>
                            <div class="menu-item pt-5">
                                <div class="menu-content"><span
                                        class="fw-bold text-muted text-uppercase fs-7">Administration</span></div>
                            </div>
                            <div class="menu-item"><a class="menu-link" href="#users"><span class="menu-icon"><i
                                            class="ki-duotone ki-profile-user fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span
                                        class="menu-title">Users</span><span
                                        class="badge badge-light-primary ms-auto">Manage</span></a></div>
                            <div class="menu-item"><a class="menu-link" href="#roles"><span class="menu-icon"><i
                                            class="ki-duotone ki-security-user fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span class="menu-title">Roles &amp;
                                        permissions</span></a></div>
                            <div class="menu-item"><a class="menu-link" href="#moderation"><span class="menu-icon"><i
                                            class="ki-duotone ki-shield-tick fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span class="menu-title">Content
                                        moderation</span></a></div>
                            <div class="menu-item"><a class="menu-link" href="#admin-templates"><span
                                        class="menu-icon"><i class="ki-duotone ki-design-1 fs-2"><span
                                                class="path1"></span><span class="path2"></span></i></span><span
                                        class="menu-title">Template catalogue</span></a></div>
                            <div class="menu-item"><a class="menu-link" href="#admin-qrcodes"><span class="menu-icon"><i
                                            class="ki-duotone ki-scan-barcode fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span class="menu-title">QR
                                        management</span></a></div>
                            <div class="menu-item"><a class="menu-link" href="#reports"><span class="menu-icon"><i
                                            class="ki-duotone ki-chart-simple-2 fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span
                                        class="menu-title">Reports</span></a>
                            </div>
                            <div class="menu-item"><a class="menu-link" href="#audit-log"><span class="menu-icon"><i
                                            class="ki-duotone ki-file-down fs-2"><span class="path1"></span><span
                                                class="path2"></span></i></span><span class="menu-title">Audit
                                        log</span></a>
                            </div>
                            <div class="menu-item"><a class="menu-link" href="#system-settings"><span
                                        class="menu-icon"><i class="ki-duotone ki-setting-2 fs-2"><span
                                                class="path1"></span><span class="path2"></span></i></span><span
                                        class="menu-title">System settings</span></a></div>
                            <div class="menu-item pt-5">
                                <div class="menu-content"><span
                                        class="fw-bold text-muted text-uppercase fs-7">Account</span></div>
                            </div>
                            <div class="menu-item"><a class="menu-link" href="{{ route('profile.manage') }}"><span
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <h1 class="d-none d-md-block fs-3 fw-bold text-gray-800 mb-0">
                                {{ $heading ?? 'Chapu CV dashboard' }}
                            </h1>
                        </div>
                        <div id="kt_header_search"
                            class="header-search d-flex align-items-center flex-grow-1 mx-5 d-none d-md-flex w-lg-300px"
                            data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter"
                            data-kt-search-layout="menu" data-kt-search-responsive="lg" data-kt-menu-trigger="auto"
                            data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
                            <form data-kt-search-element="form" class="d-block w-100 position-relative" role="search"
                                autocomplete="off"><i
                                    class="ki-duotone ki-magnifier search-icon fs-2 text-gray-500 position-absolute top-50 translate-middle-y ms-5"><span
                                        class="path1"></span><span class="path2"></span></i><input type="search"
                                    class="search-input form-control form-control-solid ps-13" name="search"
                                    placeholder="Search your CV workspace" data-kt-search-element="input"
                                    aria-label="Search your CV workspace"></form>
                        </div>
                        <div class="d-flex align-items-center gap-4">
                            <a href="{{ url('/') }}" class="btn btn-light-primary fw-bold d-none d-sm-inline">View
                                public site</a>
                            <button type="button" class="btn btn-icon btn-active-light-primary position-relative"
                                aria-label="Notifications"><i class="ki-duotone ki-notification-on fs-2"><span
                                        class="path1"></span><span class="path2"></span><span
                                        class="path3"></span></i><span
                                    class="bullet bullet-dot bg-danger position-absolute top-0 end-0"></span></button>
                            <div id="kt_header_user_menu_toggle" class="d-flex align-items-center ms-2 ms-lg-3">
                                <div class="cursor-pointer symbol symbol-35px symbol-lg-35px"
                                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-placement="bottom-end"><img alt="{{ Auth::user()->name }}"
                                        src="{{ Auth::user()->profile_photo_url }}"></div>
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    data-kt-menu="true">
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            <div class="symbol symbol-50px me-5"><img alt="{{ Auth::user()->name }}"
                                                    src="{{ Auth::user()->profile_photo_url }}"></div>
                                            <div class="d-flex flex-column"><span
                                                    class="fw-bold d-flex align-items-center fs-5">{{ Auth::user()->name }}
                                                    <span
                                                        class="badge badge-light-primary fw-bold fs-8 px-2 py-1 ms-2">Admin</span></span><span
                                                    class="fw-semibold text-muted fs-7">{{ Auth::user()->email }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="separator my-2"></div>
                                    <div class="menu-item px-5"><a href="{{ route('profile.show') }}"
                                            class="menu-link px-5">My profile</a></div>
                                    <div class="menu-item px-5"><a href="{{ url('/') }}" class="menu-link px-5">View
                                            public profile</a></div>
                                    <div class="separator my-2"></div>
                                    <div class="menu-item px-5">
                                        <form method="POST" action="{{ route('logout') }}">@csrf<button type="submit"
                                                class="menu-link px-5 border-0 bg-transparent w-100 text-start">Sign
                                                out</button></form>
                                    </div>
                                </div>
                            </div>
